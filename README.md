...
<h3>Steps Followed:</h3> <ol><ul>Created Database</ul><ul>Created Table and Columns</ul><ul>Designed Management Class Structure</ul><ul>Started coding accordingly to the design of Management class</ul></ol>
